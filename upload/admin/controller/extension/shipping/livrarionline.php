...
class ControllerExtensionShippingLivrariOnline extends Controller {
		...
		if (isset($this->error['statusawb'])) {
  		...
  		$data['breadcrumbs'] = array();
   		...
   		$data['breadcrumbs'][] = array(
			...
			'href'      => $this->url->link('extension/shipping/livrarionline', 'token=' . $this->session->data['token'], 'SSL'),
      		'separator' => ' :: '
   		);
		
		$data['action'] = $this->url->link('extension/shipping/livrarionline', 'token=' . $this->session->data['token'], 'SSL');
	...
	public function getAWB()
	{
		...
		else
		{
			...
			$raspuns .= '<form name="form-tracking-awb" id="form-tracking-awb" method="post" action="index.php?route=shipping/livrarionline/trackingAWB&token=' . $this->session->data['token'] . '">
			...
			$raspuns .= '<form name="form-cancel-awb" id="form-cancel-awb" method="post" action="index.php?route=shipping/livrarionline/cancelAWB&token=' . $this->session->data['token'] . '">
